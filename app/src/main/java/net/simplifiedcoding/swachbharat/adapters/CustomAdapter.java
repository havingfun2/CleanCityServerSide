package net.simplifiedcoding.swachbharat.adapters;
...
import net.simplifiedcoding.swachbharat.CheckComplaint;
import net.simplifiedcoding.swachbharat.R;
...
public class CustomAdapter extends RecyclerView.Adapter<CustomAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent,
        ...
        view.setOnClickListener(CheckComplaint.myOnClickListener);
